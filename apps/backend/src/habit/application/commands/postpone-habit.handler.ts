...
export class PostponeHabitCommandHandlerCore {
  ...
  public async handle(command: PostponeHabitCommand): Promise<void> {
    ...
    habit.postpone(command.minutes, new Date());
