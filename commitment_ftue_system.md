...
*   **Time to First Value (TTFV):** **< 120 segundos.** (El usuario debe experimentar el momento *"Esta app realmente me entendió"* antes del minuto 2).
...
*   **Regla del Primer Silencio:** Tras el pacto inicial, la app se desvanece a silencio absoluto. Cero tutoriales pop-up, cero promociones, cero tips molestos. Solo *"Nos vemos mañana"*.
...
*   **Journey C (Agotado Emocionalmente):** Responde *"Estoy cansado / No tengo energía"*. La IA no pide metas; ofrece el *Modo Recarga* o una acción mental de 30 segundos.
