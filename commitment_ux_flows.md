...
*   🤖 **Triggers de IA:** PROHIBIDOS ❌. Abre espacio *Presente* ──► Swipe calmo sobre micro-acción ──► Cierre automático en <10s.
...
*   🤖 **Triggers de IA:** DESACTIVADOS ❌. El sistema muestra: *"Hoy continuaremos con tu último plan confirmado."* Cero mensajes de error técnico.
...
*   🔄 **Recorrido:** Usuario comprende que el compromiso ya no representa su identidad ──► Selecciona "Cancelar Compromiso" ──► IA pregunta socráticamente: *"¿Ha cambiado tu vida o simplemente cambió tu prioridad?"* ──► Usuario responde ──► El compromiso pasa a `CanceladoConsciente` y la lección se guarda en la Biblioteca.
...
*   🔄 **Recorrido:** Usuario evoluciona su propósito (ej. de *Atleta* a *Padre Presente*) ──► Abre su Ancla de Identidad ──► Escribe su nueva visión ──► La IA ajusta suavemente los compromisos vinculados respetando la reflexión previa.
